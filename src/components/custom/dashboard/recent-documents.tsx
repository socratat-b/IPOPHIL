                    ...
                    <TooltipProvider key={`${doc.id}-${index}`} delayDuration={300}>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Card
                                    className={`group transition-all duration-200 hover:bg-accent/50 hover:shadow-md cursor-pointer border-l-4 ${hoveredId === doc.id ? 'border-l-primary' : 'border-l-transparent'
                                        }`}
